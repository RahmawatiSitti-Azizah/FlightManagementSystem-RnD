...
public class ObjectTransformer {
	public static Booking bookingFromRoute (String bookingId, Route route, Seat assignedSeat) {
		...
		return new Booking(null, bookingId, null, route.getAircraft(), route.getFromDestination(), route.getToDestination(), route.getFlightDay(), BookingStatus.CREATED.name(), assignedSeat, user);
	}
}
